...
//                 <div className="flex  min-h-full flex-col justify-center items-center p-10  w-full">
//                     <div className="sm:mx-auto sm:w-full sm:max-w-sm">
//                         <img className="mx-auto w-sm rounded-none" src="/images/logos/DDL-Logo.svg" alt="Deshalb Die Linke Logo"/>
//                     </div>
...
//                             </div>
//                             <div>
//                                 <button type="submit" className="flex w-full justify-center rounded-md bg-[var(--primary)] px-6 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Anmelden</button>
//                             </div>
//                         </form>
