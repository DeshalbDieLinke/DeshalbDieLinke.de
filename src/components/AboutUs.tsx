...
export default function AboutUs() { 
    return <div className="h-full bg-white">
            ...
            <div className="flex items-center  h-full  flex-row justify-around flex-wrap p-8">
                <TeamCard title="Eric Stehr" position="Stv. Vorsitzender vom Landesverband Sachsen-Anhalt. Fragen, Anregungen, Ideen und Presse: eric.stehr@dielinke-lsa.de" email="mailto:eric.stehr@dielinke-lsa.de" description="Stadtrat in Weißenfels" image="https://ddl.fra1.cdn.digitaloceanspaces.com/Mitwirkende/EricStehr.JPG" tag="Redakteur" insta="https://www.instagram.com/ericpolitikstuff/" x="https://x.com/EricStehr" facebook="https://www.facebook.com/EricRStehr" bluesky="https://bsky.app/profile/ericstehr.bsky.social" fotosource="Foto: Oliver Wiebe" />
