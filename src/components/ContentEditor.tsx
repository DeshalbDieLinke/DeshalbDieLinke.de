    ...
    return <>
        <div className="w-full h-full flex flex-col items-center justify-center">
            <form onSubmit={handleSubmit} className="h-[80%] lg:w-[60%] flex flex-col items-center justify-center [&>*]:m-2 border p-8 border-black rounded-md">
                    ...
                    <div className="form flex-shrink mr-20">
                        ...
                        <div className="h-[30%] ">
                            ...
                            <div className="flex flex-col">
                                ...
                                <input required className="p-2 w-[20rem]" type="text" name="description" id="description" placeholder="Beschreibung"/>
                            </div>
                            {preview &&
                                <div className="flex flex-col">
                                    <label className="text-sm">Alt Text</label>
                                    <input className="p-2 w-[20rem]" type="text" name="altText" id="altText"
                                           placeholder="Alt-Text Bild"/>
                                </div>}
                ...
                <input className="btn relative bottom-[-50px]" type="submit" value="Bild Editieren"/>
            </form>
        </div>
    </>
